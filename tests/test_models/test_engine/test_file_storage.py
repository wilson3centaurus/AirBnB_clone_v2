...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Tests method for obtaining an instance"""
        storage = FileStorage()
        ...
        retrived_state = storage.get(State, state_inst.id)

        self.assertEqual(state_inst, retrived_state)
    ...
    def test_count(self):
        ...
        city = {"name": "Ron", "state.id": state_inst.id}
