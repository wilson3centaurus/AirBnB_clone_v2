...
class DBStorage:
    ...
    def save(self):
        """ commits all changes of present database session """
        self.__session.commit()

    def delete(self, obj=None):
        """ deletes objects from present db session if not None """
        if obj is not None:
    ...
    def close(self):
        """
            calls remove() on private session attributes (self.session)
        """
